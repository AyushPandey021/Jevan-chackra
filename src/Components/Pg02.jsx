...
const Pg02 = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center mt-10 bg-[#EAC3D0] p-6 gap-10">
      {/* Video Box */}
      ...
      <div className="w-full md:w-1/2 text-center space-y-4 px-4">
        <h2 className="text-gray-700 text-6xl font-bold">Who Are We.</h2>
